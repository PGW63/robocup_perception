...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'hand_up_publisher_node = human_utils.hand_up_publisher:main',
            'test_image_bbox_subscriber = human_utils.test_image_bbox_subscriber:main',
            ...
            'hand_up_evaluation_node = human_utils.hand_up_evaluator:main',
        ],
    },
)
